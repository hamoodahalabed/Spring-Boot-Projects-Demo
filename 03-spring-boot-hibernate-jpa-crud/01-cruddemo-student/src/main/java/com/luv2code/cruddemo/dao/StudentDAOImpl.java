...
@Repository // support for component scanning and handel JDBC exception
public class StudentDAOImpl implements StudentDAO{
    ...
    public void save(Student theStudent) {
        entityManager.persist(theStudent); // save the student to the database
    }
    ...
    @Override
    @Transactional
    public int deleteAll() {                                   // entity class name
